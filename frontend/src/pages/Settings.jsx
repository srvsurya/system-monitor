  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 mb-4">
          <h2 className="font-semibold text-gray-900 mb-1">⚙️ Advanced — Optimizer Settings</h2>
          <p className="text-xs text-gray-400 mb-6">Controls what the Optimize button targets when run from the dashboard</p>

          <div className="mb-6">
            <div className="flex items-center gap-2 mb-3">
              <div className="w-2 h-2 rounded-full bg-red-500" />
              <span className="text-sm font-medium text-gray-700">CPU Hog Threshold</span>
          ...
          <div className="mb-6">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm font-medium text-gray-700">Memory Hog Threshold</span>
          ...
          <div className="mb-2">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm font-medium text-gray-700">Duplicate Process Threshold</span>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 mb-8">
          <h2 className="font-semibold text-gray-900 mb-1">🛡️ Optimizer Ignore List</h2>
          ...
          <div className="flex gap-2 mb-4">
            ...
            <button
              ...
              className="bg-black text-white text-sm px-4 py-2 rounded-lg hover:opacity-80 transition-opacity"
            >
              Add
            </button>
          </div>
            ...
            <div className="space-y-2">
              {ignoreList.map(p => (
                <div key={p.id} className="flex items-center justify-between px-3 py-2 bg-gray-50 rounded-lg border border-gray-100">
                  <span className="text-sm text-gray-700">{p.process_name}</span>
                  <button
